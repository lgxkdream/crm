...
public class CreateDao {
	public static void createFile(String tableName) {
		...
		File incomingFile = new File(CodeGeneraterConstant.txtPath + "/IDao.txt");
		File incomingImplFile = new File(CodeGeneraterConstant.txtPath + "/DaoImpl.txt");
		...
		try {
			File outFile = new File(CodeGeneraterConstant.daoPath + "/I" + CGUtil.upperFirst(tableName) + "Dao.java");
			File outImplFile = new File(CodeGeneraterConstant.daoPath + "/impl/" + CGUtil.upperFirst(tableName) + "DaoImpl.java");
