						...
						<div class="hb_row cl " >
							...
							<div class="col_10" >
								<div class="hb_itemlist" >
									<div class="mod_operations" > <a href="${contextPath}/sys/customer/toAdd" class="pn pn_add y" ><i ></i><span >客户</span></a> <span >共 3 条</span>
										<div class="operation "> <span href="#" class="btn_orderBy" > <i data-tip="排序"  ></i>
											...
											<cite > 
											<a data-tip="从Excel新增或更新数据" class="" href="tbl3.html" > <i ></i> <span >导入</span> </a> <a data-tip="将数据导出为Excel" href="###" ><i ></i><span >导出</span></a> </cite> <cite > <span class="pn_switch pn_switch_off" ><span class="checkbox" ></span><em class="on" >表格对外服务</em><em class="off" >表格对外服务</em></span> </cite> </div>
...
<script>
	jQuery(document).ready(function($) {
		...
		$.ajax({
			url : "${contextPath}/sys/customer/list",
			type : "post",
			dataType : "json",
			success : function(msg){
				...
				for(var i=0; i<list.length; i++){
					...
					str += '<td>' + customer.SOURCE + '</td>';
					str += '<td><span class="mod_category catcolor_o color_e" title="付款完成" cid="5">' + customer.STATUS + '</span></td>';
					str += '<td>' + customer.USER_ID + '</td>';
					str += '<td>' + customer.TIME_OF_CONTRACT + '</td>';
					str += '<td>' + customer.CONTACT_TIME + '</td>';
					str += '<td>' + customer.MONEY + '</td>';
